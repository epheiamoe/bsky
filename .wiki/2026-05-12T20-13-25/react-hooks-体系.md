...
function useCompose(
  client: BskyClient | null,
  goBack: () => void,
  onSuccess?: (uris?: string[]) => void,  // 新增: 返回已发布帖子的 URI 数组
): {
  ...
  threadgateRules: ThreadgateRule[] | null | undefined;  // 新增
...
[来源](packages/app/src/hooks/useAIChat.ts#L71-L92) | [来源](packages/core/src/ai/prompts.ts#L31-L143)
