现在我有完整的代码上下文了。新旧对比分析完成，开始编写更新版本。
...
[来源](packages/core/src/at/client.ts#L47-L127)
...
[来源](packages/core/src/at/client.ts#L64-L108)
...
[来源](packages/core/src/at/client.ts#L62-L108)
...
受此模式影响的方法：`getProfile`、`getAuthorFeed`、`getPostThread`、`getLikes`、`getRepostedBy`、`getFollows`、`getFollowers`、`getList`、`getLists`、`getListFeed`、`getPopularFeedGenerators`、`getFeedGenerator`、`getTrends`、`getFeed`、`listRecords`、`getRecord`、`getActorLikes`、`getRelationships`。相比旧版本，新增了 `getActorLikes` 和 `getRelationships` 两个方法（均为 [AT Play 实验功能](at-play-实验功能.md) 的社交圈分析提供数据）。
...
[来源](packages/core/src/at/client.ts#L142-L146)、[来源](packages/core/src/at/client.ts#L148-L155)、[来源](packages/core/src/at/client.ts#L220-L226)
...
[来源](packages/core/src/at/client.ts#L134-L548)
...
[来源](packages/core/src/at/client.ts#L733-L746)
...
[来源](packages/core/src/at/client.ts#L157-L780)
...
[来源](packages/core/src/at/client.ts#L652-L731)
...
[来源](packages/core/src/at/types.ts#L1-L480)
...
[来源](packages/core/src/at/client.ts#L550-L571)
