...
**v0.14.1 — 视频上传可靠性修复与删除提示优化 ✅**

v0.14.0 是一个大版本，包含多个阶段的功能开发。v0.14.1 重点修复了视频上传成功后无法播放的问题，并优化了帖子删除交互。
...
- ✅ PWA 版本升级到 v0.14.1
- 提交：`210cea5`、`3ba2408`
- 生产环境部署完成：`https://bsky.epheia.dev` / `https://ai-bsky.pages.dev`（Cloudflare Pages deployment `7e43176f`）
