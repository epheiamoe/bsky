...
- ✅ 第三方客户端 URL 支持：deer.social / tokimeki.blue / useouranos.app / deck.blue 自动重写为 bsky.app
...
**核心功能**:
- `execute_python` AI 工具（第 35 个），三平台统一架构
...
| `packages/core/src/ai/tools.ts` | 35 个 AI 工具定义（单一真相源） |
