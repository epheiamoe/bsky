...
| **发帖/回复** | ✅ | ✅ | 文本 300 字符 + 图片/视频上传(最多 4 图/1 视频, 2MB/100MB) + 引用 |
| **点赞** | ✅ | ✅ | TUI: `l` 键, PWA: 按钮 |
...
| **AI 润色** | ⬜ | ✅ | PolishWidget: 组件栏 + 浮窗模式, 复制/替换, PWA only |
| **AI 提示词定制** | ✅ | ✅ | 集中式提示词模块 `packages/core/src/ai/prompts.ts` |
| **组件系统 (Widgets)** | ⬜ | ✅ | 5 个 widget: 润色/资料页预览/推荐关注/推荐动态源/趋势; 页面限定组件置顶 |
