...
> Last updated: 2026-06-12. Complete reference for PWA migration.
...
┌──────────┐
│ @bsky/   │  纯 TS, 零 UI 依赖
│ core     │  BskyClient | AIAssistant | ApiAdapter | 35 tools | types
└────┬─────┘
     │
     ├──────────────────────────────────────┐
     │                                      │
...
│ app      │  useAuth | useTimeline   │ bsky-mcp    │  35 tools → external AI
