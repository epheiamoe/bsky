...
// ──  ChatService is now the entry point for persistence ──
// See chatService.ts for initChatService(), saveChat(), loadChat(), etc.
// This file only provides types and FileChatStorage.
