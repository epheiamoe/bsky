...
const zh: LocaleMessages = {
  ...
  'compose.draftSaveModalTitle': '保存草稿？',
  'compose.draftSaveModalDesc': '你有未保存的内容。保存为草稿以便稍后继续编辑？',
  'compose.discardDraft': '不保存',
  ...
  'compose.altMissingTitle': '缺少 ALT 文字',
  'compose.addAltNow': '去添加 ALT',
  'compose.sendWithoutAlt': '继续发送',
  ...
  'compose.videoProcessingFailed': '视频预处理失败：{message}',
  ...
  'dm.emptyWithGroupChats': '暂无 1:1 私信，有 {n} 条群聊通知',
  'nav.atplay': 'AT Play',
  ...
  'link.type.hashtag': 'Bluesky 话题标签',
  'link.type.intent': 'Bluesky 操作',
  'link.type.messages': 'Bluesky 私信',
