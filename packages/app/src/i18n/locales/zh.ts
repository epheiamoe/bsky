...
const zh: LocaleMessages = {
  ...
  'settings.scenario.imageDescription': '图片 ALT（需要视觉模型）',
  'settings.scenario.imageAltDesc': '使用 AI 为未提供 ALT 的图片生成描述。仅视觉模型可用。',
  'settings.scenario.imageAltOff': '关闭——不使用AI 生成 ALT',
